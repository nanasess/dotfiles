...
(push '(" *auto-async-byte-compile*" :height 10 :noselect t) popwin:special-display-config)
(setq anything-samewindow nil)
(push '("*my-anything*" :height 20) popwin:special-display-config)
(push '("*bzr-status*" :height 20) popwin:special-display-config)
(push '("*dvc-commit*" :height 20 :noselect t) popwin:special-display-config)
