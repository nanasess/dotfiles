...
(add-to-list 'load-path (expand-file-name
			 (concat user-site-lisp-directory "helm")))
(require 'helm-config)
...
(setq helm-howm-menu-list
      '(("m [メニュー]" . "(howm-menu)")
	("c [メモを作成]" . "(helm-howm-create-new-memo nil)")
...
(setq helm-ff-locate-db-filename "locate.database")
(setq helm-c-locate-command
  (concat "locate %s -d " locate-home-database " %s"))
