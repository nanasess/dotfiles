...
;;;***

;;;### (autoloads nil "baz-dvc" "baz-dvc.el" (19879 42006))
...
;;;;;;  "bzr-dvc" "bzr-dvc.el" (19879 42006))
...
;;;***

;;;### (autoloads (bzr-insinuate-gnus) "bzr-gnus" "bzr-gnus.el" (19879
;;;;;;  42006))
...
;;;;;;  "bzr-revision" "bzr-revision.el" (19879 42006))
...
;;;;;;  "bzr-submit" "bzr-submit.el" (19879 42006))
...
;;;***

;;;### (autoloads (dvc-about) "dvc-about" "dvc-about.el" (19879 42006))
...
;;;;;;  dvc-bookmarks) "dvc-bookmarks" "dvc-bookmarks.el" (19879
;;;;;;  42006))
...
;;;***

;;;### (autoloads nil "dvc-defs" "dvc-defs.el" (19879 42006))
...
;;;***

;;;### (autoloads (dvc-insinuate-gnus) "dvc-gnus" "dvc-gnus.el" (19879
;;;;;;  42006))
...
;;;;;;  "dvc-log" "dvc-log.el" (20015 22303))
...
;;;***

;;;### (autoloads (dvc-tips-popup) "dvc-tips" "dvc-tips.el" (19879
;;;;;;  42006))
...
;;;***

;;;### (autoloads (tla-browse) "tla-browse" "tla-browse.el" (19879
;;;;;;  42006))
...
;;;***

;;;### (autoloads nil "tla-dvc" "tla-dvc.el" (19879 42006))
...
;;;***

;;;### (autoloads (tla-insinuate-gnus) "tla-gnus" "tla-gnus.el" (19879
;;;;;;  42006))
...
;;;***

;;;### (autoloads nil "xdarcs-dvc" "xdarcs-dvc.el" (19879 42006))
...
;;;;;;  xgit-add xgit-clone xgit-init) "xgit" "xgit.el" (19879 42006))
...
;;;***

;;;### (autoloads (xgit-dvc-log) "xgit-dvc" "xgit-dvc.el" (19879
;;;;;;  42006))
...
;;;***

;;;### (autoloads (xgit-log) "xgit-log" "xgit-log.el" (19879 42006))
...
;;;;;;  "xhg-annotate" "xhg-annotate.el" (19879 42006))
...
;;;***

;;;### (autoloads (xhg-tree-root) "xhg-core" "xhg-core.el" (19879
;;;;;;  42006))
...
;;;***

;;;### (autoloads (xhg-insinuate-gnus) "xhg-gnus" "xhg-gnus.el" (19879
;;;;;;  42006))
...
;;;;;;  xhg-qrefresh xhg-qnew xhg-qinit) "xhg-mq" "xhg-mq.el" (19879
;;;;;;  42006))
...
(defvar xmtn-revlist-mode-map (let ((map (make-sparse-keymap))) (define-key map "MC" 'xmtn-revlist-show-conflicts) (define-key map "CC" 'xmtn-conflicts-clean) map))
...
(autoload 'xmtn-update-review "xmtn-revlist" "\
...
(autoload 'xmtn-sync-review "xmtn-sync" "\
...
;;;;;;  "xmtn-run.el") (20160 48141 769107))
